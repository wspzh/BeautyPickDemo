...
-(void)myDeleteLogic
{
    ...
    if ((int)_counter == 1)
    {
        _counter = (NSUInteger)([_indexPaths count]+1);
    }

    [_indexPaths removeObjectAtIndex:_counter-2];
...
-(void)_prepareForSlideShow{
    ...
    _indexPaths = [NSMutableArray arrayWithArray:mArr];
